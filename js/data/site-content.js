...
export const retreatPhotos = [
  {
    ...
    alt: "Retreat group gathered beside a forest waterfall after a cold plunge",
    rotation: -7,
    position: "center",
    layout: "portrait",
  },
  {
    ...
    alt: "Snow-covered mountain valley viewed from a winter retreat hike",
    rotation: 9,
    position: "center",
    layout: "portrait",
  },
  {
    ...
    alt: "Retreat guests gathered beneath a snow-covered tree strung with lights",
    rotation: -12,
    position: "center",
    layout: "landscape",
  },
  {
    ...
    alt: "Retreat guests posing outside the wood-fired sauna in winter",
    rotation: 6,
    position: "center",
    layout: "landscape",
  },
  {
    ...
    alt: "Rustic shared sleeping loft with beds and gongs in the retreat cabin",
    rotation: -9,
    position: "center",
    layout: "landscape",
  },
  {
    ...
    alt: "A retreat meal being prepared outdoors on a snowy evening",
    rotation: 13,
    position: "center",
    layout: "portrait",
  },
...
export const saunaPhotos = [
  {
    ...
    alt: "Wood-fired barrel sauna tucked into a misty green forest",
    rotation: 8,
    position: "center",
    layout: "landscape",
  },
  {
    ...
    alt: "Birch branches, herbal infusion, and folded towels prepared inside the sauna",
    rotation: -11,
    position: "center",
    layout: "portrait",
  },
  {
    ...
    alt: "Candlelit towels beside the round window inside the wood-fired sauna",
    rotation: 6,
    position: "center",
    layout: "portrait",
  },
  {
    ...
    alt: "Wood-fired barrel sauna glowing in the autumn forest",
    rotation: -13,
    position: "center",
    layout: "landscape",
  },
  {
    src: "./images/sauna/web/sauna-05.jpg",
    alt: "Guest receiving a traditional platza massage inside the candlelit sauna",
    rotation: 8,
    position: "center",
    layout: "portrait",
  },
...
export const eventPhotos = [
  {
    src: "./images/events/web/event-01.jpg",
    alt: "Wedding guests gathered for an outdoor ceremony beside the woodland pond",
    rotation: -7,
    position: "center",
    layout: "landscape",
  },
  {
    src: "./images/events/web/event-02.jpg",
    alt: "Wedding guests celebrating together after the woodland ceremony",
    rotation: 9,
    position: "center",
    layout: "landscape",
  },
  {
    src: "./images/events/web/event-03.jpg",
    alt: "Outdoor wedding table set beneath a leafy tree and string lights",
    rotation: -11,
    position: "center",
    layout: "portrait",
  },
  {
    src: "./images/events/web/event-04.jpg",
    alt: "Wedding guests celebrating with flowers and drinks in the woodland clearing",
    rotation: 6,
    position: "center",
    layout: "portrait",
  },
  {
    src: "./images/events/web/event-05.jpg",
    alt: "Newlyweds and guests sharing an outdoor wedding meal beneath the trees",
    rotation: -9,
    position: "center",
    layout: "portrait",
  },
  {
    src: "./images/events/web/event-06.jpg",
    alt: "DJ performing beside the woodland reception area",
    rotation: 13,
    position: "center",
    layout: "portrait",
  },
  {
    src: "./images/events/web/event-07.jpg",
    alt: "Wedding party gathered beside the pond and wood-fired sauna",
    rotation: -5,
    position: "center",
    layout: "portrait",
  },
